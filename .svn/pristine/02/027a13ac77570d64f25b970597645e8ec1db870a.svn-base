...
export interface CellValueChangedEvent<TData = any, TValue = any, TContext = any, TRawValue = any> extends CellWithDataEvent<'cellValueChanged', TData, TValue, TContext> {
    /** The value of the cell before the edit. */
    oldValue: TValue | null | undefined;
