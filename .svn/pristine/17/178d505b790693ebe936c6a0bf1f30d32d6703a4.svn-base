import type { ContextCallbackParams, DatumItemCallbackParams, HighlightState, SelectionState, SeriesCallbackParams, Styler } from '../../chart/callbackOptions';
...
export interface AgRangeAreaSeriesStylerParams<TDatum, TContext> extends SeriesCallbackParams<HighlightState, SelectionState>, ContextCallbackParams<TContext>, AgRangeAreaSeriesOptionsKeys<TDatum>, Required<AgRangeAreaSeriesStyle> {
}
...
export interface AgRangeAreaSeriesItemStylerParams<TDatum, TContext> extends AgRangeAreaSeriesOptionsKeys<TDatum>, DatumItemCallbackParams<AgRangeAreaSeriesItemType, TDatum, HighlightState>, ContextCallbackParams<TContext>, Required<AgSeriesMarkerStyle> {
    /** The type of datum. This can be `high` or `low`. */
    itemType: AgRangeAreaSeriesItemType;
}
...
export interface AgRangeAreaSeriesOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgBaseSeriesOptions<TDatum, TContext>, 'highlight'>, AgBaseCartesianSeriesAxisOptions, AgRangeAreaSeriesOptionsKeys<TDatum>, AgRangeAreaSeriesOptionsNames, AgRangeAreaSeriesThemeableOptions<TDatum, TContext> {
