...
export declare class AgColumnHeader extends Component implements IHeaderComp {
    private readonly eFilter?;
    private readonly eShowValuesAs?;
    ...
    private readonly eCalculatedColumn?;
    /**
    ...
    private setupCalculatedColumnIcon;
    private setupFilterIcon;
    private setupShowValuesAsIcon;
