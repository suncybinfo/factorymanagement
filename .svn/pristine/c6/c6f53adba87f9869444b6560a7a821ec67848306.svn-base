...
export interface AgBubbleSeriesStylerParams<TDatum, TContext> extends AgBubbleSeriesOptionsKeys<TDatum>, SeriesCallbackParams<HighlightState, SelectionState>, ContextCallbackParams<TContext>, Omit<AgBubbleSeriesStyle, 'size'> {
...
export type BubbleSeriesItemStylerParams<TDatum = DatumDefault, TContext = ContextDefault> = DatumCallbackParams<TDatum, HighlightState> & ContextCallbackParams<TContext> & AgBubbleSeriesOptionsKeys<TDatum> & Required<AgBubbleSeriesStyle>;
export type AgBubbleSeriesItemStylerParams<TDatum, TContext> = BubbleSeriesItemStylerParams<TDatum, TContext>;
export interface AgBubbleSeriesThemeableOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgBubbleSeriesStyle, 'size'>, AgBaseCartesianThemeableOptions<TDatum, TContext> {
    /**
...
export interface AgBubbleSeriesOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgBaseSeriesOptions<TDatum, TContext>, 'highlight'>, AgBaseCartesianSeriesAxisOptions, AgBubbleSeriesThemeableOptions<TDatum, TContext>, AgBubbleSeriesOptionsKeys<TDatum>, AgBubbleSeriesOptionsNames {
