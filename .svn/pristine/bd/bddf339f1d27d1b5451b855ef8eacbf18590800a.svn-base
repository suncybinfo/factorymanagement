...
import type { ContextDefault, CssColor, Degree, FontFamilyFull, FontSize, FontStyle, FontWeight, PixelSize, Ratio, TextWrap } from './types';
...
export interface AgContinuousAxisOptions<TDatum extends AgTimeValue = number, TInterval extends AgTimeInterval | AgTimeIntervalUnit | AgNumericValue = number> extends AgBaseContinuousAxisOptions<TDatum> {
...
export interface AgAxisContinuousIntervalOptions<T extends AgTimeInterval | AgTimeIntervalUnit | AgNumericValue> extends AgAxisBaseIntervalOptions {
