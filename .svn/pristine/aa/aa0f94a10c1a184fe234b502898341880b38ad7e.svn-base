import type { ContextCallbackParams, DatumCallbackParams, HighlightState, RichFormatter, Styler } from '../../chart/callbackOptions';
...
import type { FillCssOptions, FillOptions, FontOptions, LineDashOptions, Padding, StrokeOptions, Toggleable } from '../cartesian/commonOptions';
import type { AgBaseSeriesOptions, AgBaseSeriesThemeableOptions } from '../seriesOptions';
export interface AgOrganizationSeriesOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgBaseSeriesOptions<TDatum, TContext>, 'selection'>, AgOrganizationSeriesOptionsKeys, AgOrganizationSeriesThemeableOptions<TDatum, TContext> {
...
export interface AgOrganizationSeriesThemeableOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgBaseSeriesThemeableOptions<TDatum, TContext>, 'selection'> {
    /**
...
export interface AgOrganizationSeriesOptionsExpander<TDatum = DatumDefault, TContext = ContextDefault> extends AgOrganizationSeriesExpanderStyle {
    itemStyler?: Styler<AgOrganizationSeriesExpanderItemStylerParams<TDatum, TContext>, AgOrganizationSeriesExpanderStyle>;
...
export interface AgOrganizationSeriesOptionsLink<TDatum = DatumDefault, TContext = ContextDefault> extends AgOrganizationSeriesLinkStyle {
...
export interface AgOrganizationSeriesThemeableOptionsNode<TDatum = DatumDefault, TContext = ContextDefault> extends AgOrganizationSeriesNodeStyle {
...
export interface AgOrganizationSeriesOptionsNode<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgOrganizationSeriesThemeableOptionsNode<TDatum, TContext>, 'labels'> {
...
export interface AgOrganizationSeriesOptionsNodeSubtitle<TDatum = DatumDefault, TContext = ContextDefault> extends AgOrganizationSeriesOptionsNodeText<TDatum, TContext> {
    /**
     * Default: 'subtitle'
     */
    key?: string;
}
export interface AgOrganizationSeriesOptionsNodeTitle<TDatum = DatumDefault, TContext = ContextDefault> extends AgOrganizationSeriesOptionsNodeText<TDatum, TContext> {
    /**
     * Default: 'title'
     */
    key?: string;
}
export interface AgOrganizationSeriesOptionsNodeText<TDatum = DatumDefault, TContext = ContextDefault> extends AgOrganizationSeriesNodeTextStyle, Toggleable {
...
export interface AgOrganizationSeriesOptionsNodeLabel<TDatum = DatumDefault, TContext = ContextDefault> extends AgOrganizationSeriesOptionsNodeText<TDatum, TContext> {
    key: string;
}
...
export interface AgOrganizationSeriesExpanderItemStylerParams<TDatum = DatumDefault, TContext = ContextDefault> extends DatumCallbackParams<TDatum, HighlightState>, ContextCallbackParams<TContext>, AgOrganizationSeriesExpanderStyle {
    /** The depth of the data point within the organization. */
    depth: number;
    /** `true` when the node is collapsed (its descendants are hidden); `false` otherwise. */
    isCollapsed: boolean;
}
export interface AgOrganizationSeriesLinkItemStylerParams<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<DatumCallbackParams<TDatum, HighlightState>, 'datum' | 'highlightState'>, ContextCallbackParams<TContext>, AgOrganizationSeriesLinkStyle {
    /** The data point from which the link starts. */
    fromDatum: TDatum;
    /** The data point to which the link ends. */
    toDatum: TDatum;
}
export interface AgOrganizationSeriesNodeItemStylerParams<TDatum = DatumDefault, TContext = ContextDefault> extends DatumCallbackParams<TDatum, HighlightState>, ContextCallbackParams<TContext>, AgOrganizationSeriesNodeStyle {
    /** The depth of the data point within the organization. */
    depth: number;
    /** `true` when the node is collapsed (its descendants are hidden); `false` otherwise. */
    isCollapsed: boolean;
}
export interface AgOrganizationSeriesNodeTextStylerParams<TDatum = DatumDefault, TContext = ContextDefault> extends DatumCallbackParams<TDatum, HighlightState>, ContextCallbackParams<TContext>, AgOrganizationSeriesNodeTextStyle {
    /** The depth of the data point within the organisation. */
    depth: number;
    /** `true` when the node is collapsed (its descendants are hidden); `false` otherwise. */
    isCollapsed: boolean;
}
export interface AgOrganizationSeriesTooltipRendererParams<TDatum, TContext = ContextDefault> extends AgSeriesTooltipRendererParams<TDatum, TContext>, AgOrganizationSeriesOptionsKeys {
}
