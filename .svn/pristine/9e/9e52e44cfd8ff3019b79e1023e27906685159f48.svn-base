...
type HeaderAriaDescriptionKey = 'filter' | 'menu' | 'sort' | 'selectAll' | 'filterButton' | 'cellSelection' | 'showValuesAs' | 'calculatedColumn';
...
export declare class HeaderCellCtrl extends AbstractHeaderCellCtrl<IHeaderCellComp, AgColumn, ResizeFeature> {
    ...
    private refreshAriaShowValuesAs;
    private refreshAriaCellSelection;
    private refreshAriaCalculatedColumn;
