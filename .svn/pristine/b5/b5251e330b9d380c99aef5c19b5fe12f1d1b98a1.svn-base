import type { ContextCallbackParams, DatumItemCallbackParams, HighlightState, Renderer, Styler } from '../../chart/callbackOptions';
...
export type AgWaterfallSeriesItemStylerParams<TDatum = DatumDefault, TContext = ContextDefault> = DatumItemCallbackParams<AgWaterfallSeriesItemType, TDatum, HighlightState> & ContextCallbackParams<TContext> & AgWaterfallSeriesOptionsKeys<TDatum> & AgWaterfallSeriesItemParams & Required<AgWaterfallSeriesStyle>;
export type AgWaterfallSeriesLabelFormatterParams<TDatum = DatumDefault> = AgWaterfallSeriesOptionsKeys<TDatum> & AgWaterfallSeriesOptionsNames & AgWaterfallSeriesItemParams & {
...
export interface AgWaterfallSeriesTooltipRendererParams<TDatum = DatumDefault, TContext = ContextDefault> extends AgCartesianSeriesTooltipRendererParams<TDatum, TContext>, AgWaterfallSeriesStyle, AgWaterfallSeriesItemParams {
...
export interface AgWaterfallSeriesThemeableOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgBaseCartesianThemeableOptions<TDatum, TContext>, 'selection'> {
    /**
...
export interface AgWaterfallSeriesOptions<TDatum = DatumDefault, TContext = ContextDefault> extends Omit<AgBaseSeriesOptions<TDatum, TContext>, 'selection'>, AgBaseCartesianSeriesAxisOptions, AgWaterfallSeriesOptionsKeys<TDatum>, AgWaterfallSeriesOptionsNames, AgWaterfallSeriesThemeableOptions<TDatum, TContext> {
