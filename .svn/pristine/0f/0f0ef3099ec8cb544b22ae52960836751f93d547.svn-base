...
import type { AgMarkerShape, ContextDefault, DatumDefault, DatumKey, GeoJSON, LabelPlacement, PixelSize } from '../../chart/types';
...
export type AgMapMarkerSeriesItemStylerParams<TDatum = DatumDefault, TContext = ContextDefault> = DatumCallbackParams<TDatum, HighlightState> & ContextCallbackParams<TContext> & AgMapMarkerSeriesOptionsKeys<TDatum> & Required<AgMapMarkerSeriesStyle>;
