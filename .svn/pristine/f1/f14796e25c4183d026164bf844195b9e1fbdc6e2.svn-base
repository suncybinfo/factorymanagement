...
export type AgZoomEventSource = 'chart-update' | 'data-update' | 'range-check' | 'state-change' | 'sync' | 'user-interaction';
...
export interface AgNodeContextMenuActionEvent<TDatum = DatumDefault, TContext = ContextDefault> extends AgNodeClickEvent<'nodeContextMenuAction', TDatum, TContext> {
