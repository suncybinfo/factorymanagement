...
export interface ICellEditorParamsShared<TData = any, TValue = any, TContext = any> extends AgGridCommon<TData, TContext> {
...
export interface ICellEditorParams<TData = any, TValue = any, TContext = any> extends ICellEditorParamsShared<TData, TValue, TContext> {
