...
export interface AgLineCrossLineOptions<TValue = AxisValue, LabelType = AgBaseCrossLineLabelOptions> extends AgCommonCrossLineOptions<LabelType> {
    /** Renders the Cross Line as a single line positioned at `value`. */
    type: 'line';
    /** The data value at which the line should be positioned. */
    value: TValue;
}
export interface AgRangeCrossLineOptions<TValue = AxisValue, LabelType = AgBaseCrossLineLabelOptions> extends AgCommonCrossLineOptions<LabelType> {
...
export type AgBaseCrossLineOptions<TValue = AxisValue, LabelType = AgBaseCrossLineLabelOptions> = AgLineCrossLineOptions<TValue, LabelType> | AgRangeCrossLineOptions<TValue, LabelType>;
export interface AgCrossLineThemeOptions<LabelType = AgBaseCrossLineLabelOptions> extends AgCommonCrossLineOptions<LabelType> {
    /** The colour to use for the fill of the range. */
    fill?: CssColor;
    /** The opacity of the fill for the range. */
    fillOpacity?: Opacity;
